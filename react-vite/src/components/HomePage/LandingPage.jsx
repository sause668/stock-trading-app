...
export default function LandingPage() {
    return (<main id="landing-main">
        ...
        <section id="landing-main__2">
            ...
            <div>
                <p style={{margin: "16px 0 32px 0"}}>
                    Introducing three powerful, new products built for<br />
                    the next generation of active traders: Robinhood<br />
                    Legend, Futures, and Index Options. Learn how they<br /> 
                    can take your portfolio to the next level.
                </p>
                <button className="landing-btn-grn">Learn More</button>
            </div>
        </section>
        ...
        <section id="landing-main__3">
            ...
            <div>
                <div style={{display: "flex", flexDirection: "column", justifyContent: "center", height: "726px"}}>
                    ...
                    <button className="landing-btn-disclosure" style={{width: "max-content"}}><IoInformationCircleOutline /> Investing Disclosures</button>
                    <button className="landing-btn-grn" style={{marginTop: "10px", width: "max-content"}}>Learn more</button>
                </div>
        ...
        <section id="landing-main__4">
            <div>
                {/* NOTE: This svg is a vector image copied from the real Robinhood homepage. PLEASE do not touch any of this. */}
                <svg height="7%" viewBox="0 0 1199.7 149.5" >
                    <g>
                ...
                <div>
                    ...
                    <button className="landing-btn-disclosure"><IoInformationCircleOutline /> Crypto Risk Disclosures</button><br />
                    <button className="landing-btn-blk" style={{marginTop: "10px"}}>Learn more</button>
                </div>
            </div>
        ...
        <section id="landing-main__5">
            <div style={{height: "284px"}}>
                ...
                <button className="landing-btn-out">Learn more about our commitments</button>
            </div>
        ...
        <section id="landing-main__6">
            <div>
                ...
                <button className="landing-btn-blk" style={{margin: "24px 16px 12px 16px"}}>Sign up to access Robinhood Learn</button>
                <img
        ...
        <section id="landing-main__7">
            ...
            <div>
                ...
                <button className="landing-btn-grn" style={{width: "max-content"}}>Sign up</button>
            </div>
        </section>
    </main>)
}